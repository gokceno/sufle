...
const systemPrompt: string = `
  ...
  - If the user query is about **weather in any city**, you MUST immediately call the "weather" tool with that city name.
  ...
  **Available Tools:**
  - "weather": Get weather information for any city. When asked about weather for ANY city, you MUST call the "weather" tool with that city name.
